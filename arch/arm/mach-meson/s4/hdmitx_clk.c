...
static struct hw_enc_clk_val_group setting_enc_clk_val_24[] = {
	...
	/* pll setting for VESA modes */
	{
		...
		1, VIU_ENCP, 252000, 4, 4, 1, VID_PLL_DIV_5, 2, 1, 1, -1
	},
		...
		1, VIU_ENCP, 6500000, 4, 2, 1, VID_PLL_DIV_5, 2, 1, 1, -1},
	{
		...
		1, VIU_ENCP, 432000, 4, 2, 1, VID_PLL_DIV_5, 2, 1, 1, -1
	},
	{{HDMIV_1280x768p60hz,
	  GROUP_END},
	...
	{{HDMIV_1280x800p60hz,
	  GROUP_END},
		1, VIU_ENCP, 835000, 4, 2, 1, VID_PLL_DIV_5, 2, 1, 1, -1},
	{{HDMIV_1152x864p75hz,
	  HDMIV_1280x960p60hz,
	  HDMIV_1280x1024p60hz,
	  HDMIV_1600x900p60hz,
	  GROUP_END},
		1, VIU_ENCP, 1080000, 4, 1, 1, VID_PLL_DIV_5, 2, 1, 1, -1},
	{{HDMIV_1600x1200p60hz,
	  GROUP_END},
		1, VIU_ENCP, 1620000, 2, 1, 1, VID_PLL_DIV_5, 2, 1, 1, -1},
	{{HDMIV_1360x768p60hz,
	  HDMIV_1366x768p60hz,
	  GROUP_END},
		1, VIU_ENCP, 855000, 4, 1, 1, VID_PLL_DIV_5, 2, 1, 1, -1},
	{{HDMIV_1400x1050p60hz,
	  GROUP_END},
		1, VIU_ENCP, 4870000, 4, 1, 1, VID_PLL_DIV_5, 2, 1, 1, -1},
	{{HDMIV_1440x900p60hz,
	  GROUP_END},
		1, VIU_ENCP, 1065000, 4, 1, 1, VID_PLL_DIV_5, 2, 1, 1, -1},
	...
	{{HDMIV_1680x1050p60hz,
	  GROUP_END},
		1, VIU_ENCP, 1190000, 4, 1, 1, VID_PLL_DIV_5, 2, 1, 1, -1},
	{{HDMIV_1920x1200p60hz,
	  GROUP_END},
		1, VIU_ENCP, 1932500, 2, 1, 1, VID_PLL_DIV_5, 2, 1, 1, -1},
	{
		{
			HDMIV_2560x1080p60hz, GROUP_END
		},
		1, VIU_ENCP, 1980000, 2, 1, 1, VID_PLL_DIV_5, 2, 1, 1, -1
	},
	{
		{
			HDMIV_2560x1440p60hz, GROUP_END
		},
		1, VIU_ENCP, 2415000, 2, 1, 1, VID_PLL_DIV_5, 2, 1, 1, -1
	},
	{{HDMIV_2560x1600p60hz,
	  GROUP_END},
		1, VIU_ENCP, 2686200, 1, 1, 1, VID_PLL_DIV_5, 2, 1, 1, -1},
	{
		{
