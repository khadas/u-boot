...
static struct hw_enc_clk_val_group setting_enc_clk_val_24[] = {
	...
	},
	{
		...
		1, VIU_ENCP, 4032000, 4, 2, 1, CLK_UTIL_VID_PLL_DIV_5, 2, 1, 1, -1
	},
	{
		{
	...
	{
		{
			HDMIV_2048x1080p24hz, GROUP_END
		},
		1, VIU_ENCP, 5940000, 4, 2, 1, CLK_UTIL_VID_PLL_DIV_5, 2, 1, 1, -1
	},
	{
		{
	...
	{
		{
			HDMIV_3840x1080p60hz, GROUP_END
		},
		1, VIU_ENCP, 5940000, 2, 1, 1, CLK_UTIL_VID_PLL_DIV_5, 2, 1, 1, -1
	},
};
...
static void g12a_calc_pixel_clk_hpll_vco_od(u32 pixel_freq, u32 *vco_out, u32 *od1, u32 *od2)
{
	u32 htx_vco = 5940000;
	u32 div = 1;
...
next:
	...
	if (vic >= HDMITX_VESA_OFFSET) {
		...
		g12a_calc_pixel_clk_hpll_vco_od(para->timing.pixel_freq,
