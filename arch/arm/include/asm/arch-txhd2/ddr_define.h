...
#define ENABLE_CONFIG_CH0_CS0_BYTE_0_0                            BIT(0)
#define ENABLE_CONFIG_CH0_CS0_BYTE_1_1                            BIT(1)
#define ENABLE_CONFIG_CH0_CS0_BYTE_2_2                            BIT(2)
#define ENABLE_CONFIG_CH0_CS0_BYTE_3_3                            BIT(3)
#define ENABLE_CONFIG_CH0_CS1_BYTE_0_4                            BIT(4)
#define ENABLE_CONFIG_CH0_CS1_BYTE_1_5                            BIT(5)
#define ENABLE_CONFIG_CH0_CS1_BYTE_2_6                            BIT(6)
#define ENABLE_CONFIG_CH0_CS1_BYTE_3_7                            BIT(7)
#define ENABLE_CONFIG_CH1_CS0_BYTE_0_8                            BIT(8)
#define ENABLE_CONFIG_CH1_CS0_BYTE_1_9                            BIT(9)
#define ENABLE_CONFIG_CH1_CS0_BYTE_2_10                           BIT(10)
#define ENABLE_CONFIG_CH1_CS0_BYTE_3_11                           BIT(11)
#define ENABLE_CONFIG_CH1_CS1_BYTE_0_12                           BIT(12)
#define ENABLE_CONFIG_CH1_CS1_BYTE_1_13                           BIT(13)
#define ENABLE_CONFIG_CH1_CS1_BYTE_2_14                           BIT(14)
#define ENABLE_CONFIG_CH1_CS1_BYTE_3_15                           BIT(15)

//CONFIG_CH0_CS0_BYTE_01_SIZE_256 0 mean disable ,
//1 mean 256M 2 mean 512M 3 mean 768M,...0xf mean auto size det
...
#define CONFIG_DDR_FUNC_TEST                            BIT(0)
...
#define DDR_DDR4_ENABLE                                         BIT(22)
#define DDR_RANK1_ENABLE                                        BIT(21)
#define DDR_DDR4_BG_ENABLE                                      BIT(20)
#define DDR_16BIT_ENABLE                                        BIT(16)

#define DDR_RANK1_SIZE_CTRL                                     (3)
#define DDR_RANK0_SIZE_CTRL                                     (0)

/* ddr functions */
#define DDR_FUNC_D2PLL                                          BIT(0)
#define DDR_FUNC_LP                                                     BIT(1)
#define DDR_FUNC_ZQ_PD                                          BIT(2)
#define DDR_FUNC_EXT_VREF                                       BIT(3)
#define DDR_FUNC_DDR4_TIMING_TEST                       BIT(4)
#define DDR_FUNC_DDR_PLL_BYPASS                         BIT(5)
#define DDR_FUNC_RDBI                                           BIT(6)
#define DDR_FUNC_LPDDR3_CA                                      BIT(7)
#define DDR_FUNC_PRINT_WINDOW                           BIT(8)
#define DDR_FUNC_FULL_TEST                                      BIT(10)
#define DDR_FUNC_NONSEC_SCRAMBLE                        BIT(11)
#define DDR_FUNC_LPDDR3_CA_CA0_BIT0                     BIT(20)
#define DDR_FUNC_LPDDR3_CA_CA0_BIT1                     BIT(21)
#define DDR_FUNC_LPDDR3_CA_CA1_BIT0                     BIT(22)
#define DDR_FUNC_LPDDR3_CA_CA1_BIT1                     BIT(23)
#define DDR_FUNC_LPDDR3_CA_CA0_OFFSET           (20)
#define DDR_FUNC_LPDDR3_CA_CA1_OFFSET           (22)
#define DDR_FUNC_LPDDR3_SOC_ODT_ONLY_UP         BIT(25)
#define DDR_FUNC_COPY_CHANNEL_CFG                                       BIT(0)

#define DDR_FUNC_CONFIG_AXI_NOC_MODE_5          BIT(23)
#define DDR_FUNC_CONFIG_AXI_NOC_MODE_6          BIT(24)
#define DDR_FUNC_FORCE_DDR_WINDOW_TEST_ON_POWER_OFF_STAGE               BIT(25)
#define DDR_FUNC_CONFIG_DISABLE_FORCE_TRAINING_DQ_INIT_DELAY_VALUE_FUNCTION     BIT(26)
#define DDR_FUNC_CONFIG_DISABLE_FORCE_TRAINING_1D_DEV_INIT_FUNCTION             BIT(27)
#define DDR_FUNC_CONFIG_DDR_DVFS_FUNCTION       BIT(28)
#define DDR_FUNC_CONFIG_DFE_FUNCTION            BIT(29)
#define DDR_FUNC_FAST_BOOT_CHECK_CHIP_ID        BIT(30)
#define DDR_FUNC_SCRAMBLE                                       BIT(31)
...
#define DDR_ENABLE_FINE_TUNE_FLAG_AC_DELAY                              BIT(0)
#define DDR_ENABLE_FINE_TUNE_FLAG_WRITE_DQS                             BIT(1)
#define DDR_ENABLE_FINE_TUNE_FLAG_READ_DQS                              BIT(2)
#define DDR_ENABLE_FINE_TUNE_FLAG_WRITE_DQ                              BIT(3)
#define DDR_ENABLE_FINE_TUNE_FLAG_READ_DQ                               BIT(4)
...
#define         LOG_LEVEL_BASIC         BIT(eLOG_CHL_0)
#define         LOG_LEVEL_FULL          BIT(eLOG_CHL_0) | BIT(eLOG_CHL_1) | \
	BIT(eLOG_CHL_2) | BIT(eLOG_CHL_3) | BIT(eLOG_CHL_4) | \
	BIT(eLOG_CHL_5) | BIT(eLOG_CHL_6)
#define         LOG_LEVEL_DEBUG         BIT(eLOG_CHL_0) | BIT(eLOG_CHL_1) | \
	BIT(eLOG_CHL_2) | BIT(eLOG_CHL_3) | BIT(eLOG_CHL_4) | BIT(eLOG_CHL_5) | \
	BIT(eLOG_CHL_6) | BIT(eLOG_CHL_7)
...
#define DDR_DMC_REMAP_DDR4_32BIT                                                           \
	{                                                                                      \
		...
		[2] = (18 | 19 << 5 | 20 << 10 | 21 << 15 | 22 << 20 | 23 << 25),          \
		[3] = (24 | 25 << 5 | 26 << 10 | 27 << 15 | 28 << 20 | 29 << 25),          \
		[4] = (30 | 13 << 5 | 14 << 10 | 6 << 15 | 31 << 20 | 31 << 25),            \
	}
...
#define DDR_DMC_REMAP_DDR4_16BIT_2                                                         \
	{                                                                                      \
...
#define DDR_DMC_REMAP_LPDDR4_16BIT_T3X                         \
	{                                                        \
		[0] =  (0 |  5 << 6 |  6 << 12 |  7 << 18 |  8 << 24),\
		[1] =  (9 | 10 << 6 |  0 << 12 |  0 << 18 | 11 << 24),\
		[2] =  (15 | 16 << 6 | 17 << 12 | 18 << 18 | 19 << 24),\
		[3] =  (20 | 21 << 6 | 22 << 12 | 23 << 18 | 24 << 24),\
		[4] =  (25 | 26 << 6 | 27 << 12 | 28 << 18 | 29 << 24),\
		[5] =  (12 | 13 << 6 | 14 << 12 | 30 << 18 | 31 << 24),\
	}
#define DDR_DMC_REMAP_DDR4_16BIT_T3X                       \
	{                                                          \
		[0] = (0 |  5 << 6 |  7 << 12 |  8 << 18 |  9 << 24), \
		[1] = (10 | 11 << 6 |  0 << 12 |  0 << 18 | 14 << 24), \
		[2] = (15 | 16 << 6 | 17 << 12 | 18 << 18 | 19 << 24),\
		[3] = (20 | 21 << 6 | 22 << 12 | 23 << 18 | 24 << 24),\
		[4] = (25 | 26 << 6 | 27 << 12 | 28 << 18 | 29 << 24),\
		[5] = (12 | 13 << 6 |  6 << 12 |  0 << 18 |  0 << 24),\
	}
#define DDR_DMC_REMAP_DDR4_32BIT_T3X                       \
	{                                                          \
		[0] = (5 |  7 << 6 |  8 << 12 |  9 << 18 | 10 << 24), \
		[1] = (11 | 12 << 6 |  0 << 12 |  0 << 18 | 15 << 24), \
		[2] = (16 | 17 << 6 | 18 << 12 | 19 << 18 | 20 << 24),\
		[3] = (21 | 22 << 6 | 23 << 12 | 24 << 18 | 25 << 24),\
		[4] = (26 | 27 << 6 | 28 << 12 | 29 << 18 | 30 << 24),\
		[5] = (13 | 14 << 6 |  6 << 12 | 31 << 18 |  0 << 24),\
	}
#define DDR_DMC_REMAP_DDR3_16BIT_T3X                       \
	{                                                          \
		[0] = (0 |  5 << 6 |  6 << 12 |  7 << 18 |  8 << 24), \
		[1] = (9 | 10 << 6 |  0 << 12 |  0 << 18 | 11 << 24), \
		[2] = (15 | 16 << 6 | 17 << 12 | 18 << 18 | 19 << 24),\
		[3] = (20 | 21 << 6 | 22 << 12 | 23 << 18 | 24 << 24),\
		[4] = (25 | 26 << 6 | 27 << 12 | 28 << 18 | 29 << 24),\
		[5] = (12 | 13 << 6 |  14 << 12 |  0 << 18 |  0 << 24),\
	}
#define DDR_DMC_REMAP_DDR3_32BIT_T3X                       \
	{                                                          \
		[0] = (5 |  6 << 6 |  7 << 12 |  8 << 18 | 9 << 24), \
		[1] = (10 | 11 << 6 |  0 << 12 |  0 << 18 | 15 << 24), \
		[2] = (16 | 17 << 6 | 18 << 12 | 19 << 18 | 20 << 24),\
		[3] = (21 | 22 << 6 | 23 << 12 | 24 << 18 | 25 << 24),\
		[4] = (26 | 27 << 6 | 28 << 12 | 29 << 18 | 30 << 24),\
		[5] = (12 | 13 << 6 | 14 << 12 | 31 << 18 |  0 << 24),\
	}
...
#define DMC_TEST_SLT_OFFSET_DELAY                               BIT(1)
#define DMC_TEST_SLT_ENABLE_DDR_SKIP_TRAINING   BIT(6)
#define DMC_TEST_SLT_ENABLE_DDR_DVFS                    BIT(7)

#define DMC_TEST_SLT_ENABLE_DDR_AUTO_WINDOW_TEST BIT(4)
