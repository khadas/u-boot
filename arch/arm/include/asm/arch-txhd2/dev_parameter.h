...
/*
 * arch/arm/include/asm/arch-sc2/dev_parameter.h
 *
...
typedef struct nand_parameter {
	...
	uint32_t bbt_pages;
	/* for bl2 stage, it can quickly generate the small
	part of the fromt bbt table. 20 for start block of bbt scanning */
