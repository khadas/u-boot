...
/*
 * arch/arm/include/asm/arch-t5d/uart.h
 *
...
#define UART_PORT_0     ((0x8c00  << 2) + 0xffd00000)
#define UART_PORT_1     ((0x8c00  << 2) + 0xffd00000)
#define UART_PORT_AO    ((0x8c00  << 2) + 0xffd00000)
#define UART_WFIFO      0
#define UART_RFIFO      1
