...
#define MESON_I2C_MASTER_B_GPIODV_27_BIT		(1<<12)
 /*i2c master c*/
#define MESON_I2C_MASTER_C_GPIODV_18_REG		(P_PERIPHS_PIN_MUX_1)
#define MESON_I2C_MASTER_C_GPIODV_18_BIT		(1<<17)
#define MESON_I2C_MASTER_C_GPIODV_19_REG		(P_PERIPHS_PIN_MUX_1)
#define MESON_I2C_MASTER_C_GPIODV_19_BIT		(1<<16)

/*i2c master d*/
#define MESON_I2C_MASTER_D_GPIOX_10_REG			(PERIPHS_PIN_MUX_5)
#define MESON_I2C_MASTER_D_GPIOX_10_BIT			(1<<5)
#define MESON_I2C_MASTER_D_GPIOX_11_REG			(PERIPHS_PIN_MUX_5)
#define MESON_I2C_MASTER_D_GPIOX_11_BIT			(1<<4)
