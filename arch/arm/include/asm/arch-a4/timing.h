...
} __attribute__ ((__packed__)) bl2_reg_t;
...
typedef struct ddr_reg {
	...
	unsigned char	flag;
	unsigned char	rsv_0;
} __attribute__ ((__packed__)) ddr_reg_t;
...
//}  __packed training_delay_set_ps_t;
...
#endif
} __attribute__ ((__packed__)) ddr_timing_t;
...
} __attribute__ ((__packed__)) board_common_setting_t;
...
} __attribute__ ((__packed__)) board_SI_setting_ps_t;
...
} __attribute__ ((__packed__)) board_phase_setting_ps_t;
...
} __attribute__ ((__packed__)) ddr_set_t;
...
} __attribute__ ((__packed__)) ddr_set_ps0_only_t;
...
} __attribute__ ((__packed__)) board_clk_set_t;
...
} __attribute__ ((__packed__)) pll_ctrl_t;
...
} __attribute__ ((__packed__)) pll_set_t;
...
typedef struct bl2_sec_parameter {
	...
	uint32_t	RFU[27];
} __attribute__ ((__packed__)) sec_parameter_t;
