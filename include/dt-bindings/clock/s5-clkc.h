...
#define CLKID_FCLK_CLK50M	8
#define CLKID_SYS_CLK		9
#define	CLKID_ETH_CORE		10
#define CLKID_SYS_PLL		11
#define CLKID_GP0_PLL		12
#define CLKID_GP1_PLL		13
...
#define CLKID_SD_EMMC_A_GATE	(CLKID_GATE_BASE + 4)
#define CLKID_SD_EMMC_B_GATE	(CLKID_GATE_BASE + 5)
#define CLKID_SD_EMMC_C_GATE		(CLKID_GATE_BASE + 6)
#define CLKID_ETH_125M_GATE		(CLKID_GATE_BASE + 7)
#define CLKID_ETH_RMII_GATE	(CLKID_GATE_BASE + 8)
...
#define CLKID_SD_EMMC_A_MUX	(CLKID_MUX_BASE + 4)
#define CLKID_SD_EMMC_B_MUX	(CLKID_MUX_BASE + 5)
#define CLKID_SD_EMMC_C_MUX		(CLKID_MUX_BASE + 6)
#define CLKID_ETH_RMII_MUX	(CLKID_MUX_BASE + 7)

#define CLKID_DIV_BASE		(CLKID_MUX_BASE + 8)
...
#define CLKID_SD_EMMC_B_DIV	(CLKID_DIV_BASE + 5)
#define CLKID_SD_EMMC_C_DIV		(CLKID_DIV_BASE + 6)
#define CLKID_ETH_RMII_DIV	(CLKID_DIV_BASE + 7)

#define CLKID_END_BASE      (CLKID_DIV_BASE + 8)
