...
#ifndef __DT_BINDINGS_CLOCK_T3_H
#define __DT_BINDINGS_CLOCK_T3_H
/*
 * CLKID index values
 */
#define CLKID_XTAL		0
...
#define CLKID_SD_EMMC_B_GATE	(CLKID_GATE_BASE + 3)
#define CLKID_SD_EMMC_C_GATE	(CLKID_GATE_BASE + 4)
#define CLKID_SD_EMMC_A_GATE	(CLKID_GATE_BASE + 5)
...
#define CLKID_SD_EMMC_B_MUX	(CLKID_MUX_BASE + 3)
#define CLKID_SD_EMMC_C_MUX	(CLKID_MUX_BASE + 4)
...
#define CLKID_SD_EMMC_B_DIV	(CLKID_DIV_BASE + 3)
#define CLKID_SD_EMMC_C_DIV	(CLKID_DIV_BASE + 4)
#define CLKID_SD_EMMC_A_DIV	(CLKID_MUX_BASE + 5)
