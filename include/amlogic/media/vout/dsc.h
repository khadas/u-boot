...
enum dsc_encode_mode dsc_enc_confirm_mode(unsigned int pic_width, unsigned int pic_height,
...
void dsc_enc_cap_show(void);
void dsc_debug(int argc, char *const parm[]);
