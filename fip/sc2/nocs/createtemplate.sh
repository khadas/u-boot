...
./fip/sc2/generate-device-keys/bin/gen_device_aes_protkey.sh --rootkey-index 0  --project s905c2 --key-dir ./dv_scs_keys --template-dir ./soc/templates/sc2/ ${device_fip_arb_args}
./fip/sc2/generate-device-keys/bin/gen_device_root_hash.sh --rootkey-index 0 --key-dir ./dv_scs_keys --project s905c2 --template-dir ./soc/templates/sc2/ ${boot_blobs_arb_args}
./fip/sc2/generate-device-keys/bin/export_dv_scs_signing_keys.sh --key-dir ./dv_scs_keys --out-dir ./bl33/v2019/board/amlogic/$1/device-keys --rootkey-index 0 --project s905c2
