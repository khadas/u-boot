...
if [ -z "$PROJECT" ]; then
	...
	BASEDIR_BOOTBLOBS_TEMPALTE_ROOT="${BASEDIR_ROOT}/boot-blobs/template/rootrsa-${DEVICE_ROOTRSA_INDEX}"
	...
	BASEDIR_BOOTBLOBS_TEMPALTE_ROOT="${BASEDIR_ROOT}/boot-blobs/template/${PROJECT}/rootrsa-${DEVICE_ROOTRSA_INDEX}"
...
BASEDIR_DEVICE_TEMPLATE="${BASEDIR_BOOTBLOBS_TEMPALTE_ROOT}"
