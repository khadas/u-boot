...
#define   USCRATCHCSWL    0x049


//#define CSR_MISA          0x048

#define CSR_PUSHUCAUSE    0x849
#define CSR_PUSHUEPC      0x84a
#define CSR_UNXTI         0x045
#define CSR_JLUNXTI       0x847


#define CSR_LSTEPCTRL      0x7e8
#define CSR_LSTEPFORC      0x7e9

#define CSR_SCPCTRL        0x7f3
...
//#endif
#define read_csr_msubmode     read_csr(0x7c4)
...
DECLARE_CSR(mcounterstop,   CSR_MCOUNTERSTOP)
DECLARE_CSR(istatus,        CSR_ISTATUS     )
DECLARE_CSR(nstatus,        CSR_NSTATUS     )
DECLARE_CSR(mivec,          CSR_MIVEC       )
DECLARE_CSR(mnvec,          CSR_MNVEC       )
DECLARE_CSR(msubmode,       CSR_MSUBMODE    )
DECLARE_CSR(mscratch1,      CSR_MSCRATCH1   )
DECLARE_CSR(mnpc,           CSR_MNPC        )
DECLARE_CSR(mipc,           CSR_MIPC        )
DECLARE_CSR(dbgstop,        CSR_DBGSTOP     )
DECLARE_CSR(wfimode,        CSR_WFIMODE     )
