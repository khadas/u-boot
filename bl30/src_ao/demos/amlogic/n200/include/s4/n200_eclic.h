...
#define ECLIC_INT_ATTR_MACH_MODE        0xC0
...
#define ECLIC_INTERNAL_NUM_INTERRUPTS 19
#define ECLIC_NUM_INTERRUPTS (SOC_ECLIC_NUM_INTERRUPTS + ECLIC_INTERNAL_NUM_INTERRUPTS)
