...
#define DMC_SOFT_RST2                    ((0x0003  << 2) + 0xff638000)
  ...
  //bit 4.  DMC low power control moudle soft reset_n.
  //0 : reset. 1 : normal working mode.
  //bit 3.  DMC QOS monitor module soft reset_n.
  //0 : reset. 1 : normal working mode.
  //bit 2.  DMC register modle soft reset_n.
  //0 : reset. 1 : normal working mode.
...
#define DMC_MON0_CTRL                    ((0x0025  << 2) + 0xff638000)
  //BW MONTIOR 0 address range ctrol.
...
#define DMC_MON0_BW                      ((0x0028  << 2) + 0xff638000)
  // at the test period,
  //this range granted data cycles for the seletec channel and ports.

#define DMC_MON1_CTRL                    ((0x0029  << 2) + 0xff638000)
  //BW monitor 1 address range ctrol.
  //start addrss <= AXI address[31:16] <= end address
  //bit 31:16  End address[31:16]
  //bit 15:0.  start address[31:16]
...
#define DMC_MON2_CTRL                    ((0x002d  << 2) + 0xff638000)
  //BW monitor 2 address range ctrol.
  //start addrss <= AXI address[31:16] <= end address
  //bit 31:16  End address[31:16]
  //bit 15:0.  start address[31:16]
...
#define DMC_MON3_CTRL                    ((0x0031  << 2) + 0xff638000)
  //BW monitor 3 address range ctrol.
  //start addrss <= AXI address[31:16] <= end address
  //bit 31:16  End address[31:16]
  //bit 15:0.  start address[31:16]
...
#define DMC_MON4_CTRL                    ((0x0035  << 2) + 0xff638000)
  //BW monitor 4 address range ctrol.
  //start addrss <= AXI address[31:16] <= end address
  //bit 31:16  End address[31:16]
  //bit 15:0.  start address[31:16]
...
#define DMC_MON5_CTRL                    ((0x0039  << 2) + 0xff638000)
  //BW monitor 5 address range ctrol.
  //start addrss <= AXI address[31:16] <= end address
  //bit 31:16  End address[31:16]
  //bit 15:0.  start address[31:16]
...
#define DMC_MON6_CTRL                    ((0x003d  << 2) + 0xff638000)
  //BW monitor 6 address range ctrol.
  //start addrss <= AXI address[31:16] <= end address
  //bit 31:16  End address[31:16]
  //bit 15:0.  start address[31:16]
...
#define DMC_MON7_CTRL                    ((0x0041  << 2) + 0xff638000)
  //BW monitor 7 address range ctrol.
  //start addrss <= AXI address[31:16] <= end address
  //bit 31:16  End address[31:16]
  //bit 15:0.  start address[31:16]
...
#define DMC_CHAN_STS                     ((0x00ce  << 2) + 0xff638000)
  //AXI0  is first CPU and Mali conbined channel from CCI-400 directly.
...
#define DMC_TEST_CTRL                    ((0x0002  << 2) + 0xff639800)
   ...
   //bit 27.  enabe to compare data.
   //         when do the read enable to enable the error comparaion.
...
#define DMC_DRAM_ZQCTRL                  ((0x003d  << 2) + 0xff638400)
  ...
  //which refresh period count to send partical ZQCS/ZACAL/ZQUPD command
...
#define DMC_DRAM_ASR_CTRL                ((0x008d  << 2) + 0xff638400)
  ...
  //bit 15:0.   0 disable auto ASR mode.
	     // Non-zero valule enable ASR mode.
	     //when DMC is in idle state for this number of clock cycles,
...
// -----------------------------------------------
//those register is for software save some tempary value.
...
#define DMC_SEC_RANGE0_CTRL1                  ((0x0001  << 2) + 0xff639000)
  ...
  //bit 3  | 0 | range0_local_des_en  | range0 data describle enable.
  //             1: enable. 0 : disable.
  //             this bit works together with GLOBAL_DES_EN to
  //             decide this region data describle enable or not.
...
#define DMC_SEC_RANGE1_CTRL1                  ((0x0003  << 2) + 0xff639000)
  ...
  //             1: allowed.  0: not allowed.
  //bit 3  | 0 | range1_local_des_en  | range1 data describle enable.
  //             1: enable. 0 : disable.
  //             this bit works together with GLOBAL_DES_EN to
  //             decide this region data describle enable or not.
...
#define DMC_SEC_RANGE2_CTRL1                  ((0x0005  << 2) + 0xff639000)
  ...
  //             1: allowed.  0: not allowed.
  //bit 3  | 0 | range2_local_des_en  | range2 data describle enable.
  //       1: enable. 0 : disable.
...
#define DMC_SEC_RANGE3_CTRL1                  ((0x0007  << 2) + 0xff639000)
  ...
  //             1: allowed.  0: not allowed.
  //bit 3  | 0 | range3_local_des_en  | range3 data describle enable.
  //       1: enable. 0 : disable.
  //       this bit works together with GLOBAL_DES to
  //       decide this region data describle enable or not.
...
#define DMC_SEC_RANGE4_CTRL1                  ((0x0009  << 2) + 0xff639000)
  ...
  //             1: allowed.  0: not allowed.
  //bit 3  | 0 | range4_local_des_en  | range4 data describle enable.
  //       1: enable. 0 : disable.
  //       this bit works together with GLOBAL_DES to
  //       decide this region data describle enable or not.
...
#define DMC_SEC_RANGE15_CTRL1                 ((0x001f  << 2) + 0xff639000)
  ...
  //bit 2  | 0 | range1_lock  |  lock range 1 registers.
  //       write 1 to lock range 1 register. can't change anymore.
  //bit 1  | 0 | range1_key_sel | range 1 data describle key selection.
  //1 : key1. 1 : key0.
...
//bit 63:56 not used.
//bit 79:64 for HEVC 16 secuirity levels.
//bit 87:80 for VDEC  8 security levels.
//bit 88 for GE2D secruit video.
//bit 89 for GE2D secruit video.
...
#define DMC_SEC_STATUS                   ((0x00fa  << 2) + 0xff639000)
 ...
 //       ( APB bus WDATA not equre the register value when APB write).
 //       write 1 to clean this bit to 0.
 //bit 2   sec_alert.   1 DMC secruity register alert function triggered.
...
#define DMC_VIO_ADDR3                    ((0x00fe  << 2) + 0xff639000)
  ...
  //15:0   ddr 0 read violation ID. bit 13~9 Marster ID. bit 7:4 subid.
