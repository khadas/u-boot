...
#define CONFIG_VDDEE_INIT_VOLTAGE	880		// kvim3l VDDEE voltage setting
#define CONFIG_VDDEE_INIT_VOLTAGE_SM1	840		// kvim3l VDDEE voltage setting
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"initargs="\
		"rootflags=data=writeback rw rootfstype=ext4 "\
		"no_console_suspend "\
	...
	"recovery_from_flash="\
		...
		"\0"\
	"load_bmp_logo="\
		"if load mmc 1:5 ${loadaddr} /usr/share/fenix/logo/logo.bmp; then "\
