...
#define CONFIG_EXTRA_ENV_SETTINGS \
        ...
        "check_panel="\
				...
				"if test ${khadas_mipi_id} = 1; then "\
                    ...
                    "fdt set /meson-fb display_size_default <0x00000438 0x00000780 0x00000438 0x00000f00 0x00000020>;"\
				"else if test ${khadas_mipi_id} = 2; then "\
                    ...
                    "fdt set /meson-fb display_size_default <0x00000780 0x000004b0 0x00000780 0x00000960 0x00000020>;"\
        ...
        "ext_ethernet_change="\
            ...
            "if test ${ext_ethernet} = 1; then "\
                "echo use M2X internal 100M network;"\
                ...
                "fdt set /ethernet@ff3f0000 pinctrl-0 <0x000000d3>;"\
            "else "\
                ...
                "fdt set /ethernet@ff3f0000 pinctrl-0 <0x00000029>;"\
            "fi;"\
            "\0"\
        "cmdline_keys="\
            "kbi usid noprint;"\
