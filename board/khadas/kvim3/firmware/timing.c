...
{
	/* lpddr4x Micron MT53D1024M32D4 2 RANKs 4GB */
	...
	.soc_data_odt_ohm_n		= 80,	//4layer 40/60;
	...
	.vref_output_permil		= 300,// (5500/2*6)*130/100,// 260,//200,
	.vref_receiver_permil	= 200,//180,//(250*6/11)*110/100,
	.vref_dram_permil		= 270,//180,//300,//200,//(250*11/6),
	//.vref_reverse			= 0,
	...
	.bitTimeControl_2d      = 1,
	.fast_boot[0]			= 0,
	.enable_lpddr4x_mode	= 0,
	.training_offset = ((0 << 7) | (0 << 4)) | ((1 << 3) | (1 << 0))
},
{
