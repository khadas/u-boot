...
/*
 * board/amlogic/t5d_am319_v1/t5d_am319_v1.c
 *
...
int checkhw(char * name)
{
	...
	switch (cpu_id.chip_rev) {
		case 0xA:
			switch (ddr_size) {
				case 0x80000000:
					strcpy(dtb_name, "t5d-reva_t950x4_am319-2g\0");
					break;
				case 0x40000000:
					strcpy(dtb_name, "t5d-reva_t950x4_am319-1g\0");
					break;
				case 0x20000000:
					strcpy(dtb_name, "t5d-reva_t950x4_am319-512m\0");
					break;
				default:
