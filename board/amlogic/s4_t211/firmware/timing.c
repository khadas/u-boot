...
uint32_t __bl2_ddr_reg_data[] __attribute__ ((section(".ddr_2acs_data"))) = {
	...
	DDR_TIMMING_TUNE_TIMMING0_F(cfg_board_SI_setting_ps.vref_dram_data_permil,					  750),
};
...
ddr_set_ps0_only_t __ddr_setting[] __attribute__ ((section(".ddr_param"))) = {
#if 1   //timing_config,T211
	{
		...
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[70] = 0x00000000,      // 0
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[71] = 0x00000000,      // 0
		.cfg_ddr_training_delay_ps.read_dqs_gate_delay[0] = 0x00000356,      // 854
		.cfg_ddr_training_delay_ps.read_dqs_gate_delay[1] = 0x00000357,      // 855
		.cfg_ddr_training_delay_ps.read_dqs_gate_delay[2] = 0x0000033e,      // 830
		.cfg_ddr_training_delay_ps.read_dqs_gate_delay[3] = 0x00000348,      // 840
