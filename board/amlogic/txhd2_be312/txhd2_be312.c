...
/*
 * board/amlogic/txhd2_be311/txhd2_be311.c
 *
...
int checkhw(char * name)
{
	...
	case 0x20000000:
		if (cpu_id.chip_rev == 0xA)
			strcpy(loc_name, "txhd2-reva_t950s_be312-512m\0");
		else
			strcpy(loc_name, "txhd2_t950s_be312-512m\0");
		break;
	case 0x40000000:
		if (cpu_id.chip_rev == 0xA)
			strcpy(loc_name, "txhd2-reva_t950s_be312\0");
		else
			strcpy(loc_name, "txhd2_t950s_be312\0");
		break;
	default:
