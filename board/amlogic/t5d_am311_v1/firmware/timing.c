...
/*
 * board/amlogic/t5d_am311_v1/firmware/timing.c
 *
...
ddr_set_t __ddr_setting[] __attribute__ ((section(".ddr_settings"))) = {
	{
		...
		.cfg_ddr_training_delay_ps[0].ac_trace_delay ={
			...
			256, 256, 256,	     256 + 100, 256, 256 + 100, 256, 256,
			256, 256, 256,	     256,	256, 256,	256, 256,
			256, 256, 256,	     256,	256, 256 + 30,	256, 256,
			256, 256, 256 + 100, 256,
		}, //total 36
#if 0
		...
		.cfg_ddr_training_delay_ps[0].soc_bit_vref[32] = (915 - 240) / 15,      // 43
		.cfg_ddr_training_delay_ps[0].soc_bit_vref[33] = (915 - 240) / 15,      // 43
		.cfg_ddr_training_delay_ps[0].soc_bit_vref[34] = (915 - 240) / 15,      // 43
		.cfg_ddr_training_delay_ps[0].soc_bit_vref[35] = (915 - 240) / 15,      // 43
		.cfg_ddr_training_delay_ps[0].soc_bit_vref[36] = (915 - 240) / 15,      // 43
		.cfg_ddr_training_delay_ps[0].soc_bit_vref[37] = 0x00000035,            // 53
		.cfg_ddr_training_delay_ps[0].soc_bit_vref[38] = (915 - 240) / 15,      // 43
		.cfg_ddr_training_delay_ps[0].soc_bit_vref[39] = 0x00000035,            // 51
		.cfg_ddr_training_delay_ps[0].soc_bit_vref[40] = (915 - 240) / 15,      // 43
		.cfg_ddr_training_delay_ps[0].soc_bit_vref[41] = 0x00000036,            // 54
		.cfg_ddr_training_delay_ps[0].soc_bit_vref[42] = (915 - 240) / 15,      // 43
