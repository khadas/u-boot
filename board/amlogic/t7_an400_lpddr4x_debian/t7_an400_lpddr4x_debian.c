	...
	if (!p_aml_dt) {
		...
		case CONFIG_T7_4G_SIZE:
			if (cpu_id.chip_rev == 0xA || cpu_id.chip_rev == 0xb) {
				...
				/* haotian TODO, If hdmitx_only in the uboot
				 * environment variable is defined as true,
				 * use t7_a311d2_an400_drm_hdmitx_only_debian.dtb
				 */
				//if (env_get("hdmitx_only")) {
				//	strncpy(fdtfile_name,
				//		"t7_a311d2_an400_drm_hdmitx_only_debian.dtb\0",
				//		sizeof(fdtfile_name));
				//} else {
				...
				/* haotian TODO, If hdmitx_only in the uboot
				 * environment variable is defined as true,
				 * use t7c_a311d2_an400_linux_drm_hdmitx_only_debian.dtb
				 */
				//if (env_get("hdmitx_only")) {
				//	strncpy(fdtfile_name,
				//	"t7c_a311d2_an400_linux_drm_hdmitx_only_debian.dtb\0",
