...
/*
 * board/amlogic/configs/t5_ak309_v1.h
 *
        ...
        "cmdline_keys="\
            "if keyman init 0x1234; then "\
                "if keyman read usid ${loadaddr} str; then "\
                    ...
                    "setenv serial ${usid};"\
                "else "\
					"setenv bootargs ${bootargs} androidboot.serialno=ak309${cpu_id};"\
					"setenv serial ak309${cpu_id};"\
                "fi;"\
...
/* cpu */
#define CONFIG_CPU_CLK			2004 //MHz. Range: 360-2004, should be multiple of 24
...
#define CONFIG_DEVICE_PRODUCT	"t9623_ak309"
