...
/*
 * board/amlogic/configs/axg_s410_v1_gva.h
 *
 * Copyright (C) 2020 Amlogic, Inc. All rights reserved.
 *
 */

#ifndef __AXG_S410_V1_GVA_H__
#define __AXG_S410_V1_GVA_H__
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"lcd_debug=0x00000000\0" \
        ...
        "storeargs="\
            ...
            "setenv bootargs ${initargs} reboot_mode_android=${reboot_mode_android} logo=${display_layer},loaded,${fb_addr} vout=${outputmode},enable panel_type=${panel_type} lcd_ctrl=${lcd_ctrl} lcd_debug=${lcd_debug} osd_reverse=${osd_reverse} video_reverse=${video_reverse} androidboot.selinux=${EnableSelinux} androidboot.firstboot=${firstboot} jtag=${jtag}; "\
        ...
        "cmdline_keys="\
            "if keyman init 0x1234; then "\
                "if keyman read usid ${loadaddr} str; then "\
                    ...
                    "setenv serial ${usid};"\
                "else "\
					"setenv bootargs ${bootargs} androidboot.serialno=s410gva${cpu_id};"\
					"setenv serial s410gva${cpu_id};"\
                "fi;"\
...
#define CONFIG_DEVICE_PRODUCT	"axg_s410"
