...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"outputmode=panel\0" \
        ...
        "storeargs="\
            ...
            "setenv bootargs ${initargs} logo=${display_layer},loaded,${fb_addr} vout=${outputmode},enable panel_type=${panel_type} lcd_ctrl={lcd_ctrl} lcd_debug=${lcd_debug} osd_reverse=${osd_reverse} video_reverse=${video_reverse} androidboot.selinux=${EnableSelinux} androidboot.firstboot=${firstboot} jtag=${jtag} i2c_auto_test=${i2c_auto_test}; "\
