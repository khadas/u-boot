...
/*
 * board/amlogic/configs/t5d_am311_v1.h
 *
        ...
        "cmdline_keys="\
            "if keyman init 0x1234; then "\
                "if keyman read usid ${loadaddr} str; then "\
                    ...
                    "setenv serial ${usid};"\
                "else "\
					"setenv bootargs ${bootargs} androidboot.serialno=am311${cpu_id};"\
					"setenv serial am311${cpu_id};"\
                "fi;"\
...
/* cpu */
#define CONFIG_CPU_CLK				1908 //MHz. Range: 100-1908
...
#define CONFIG_DEVICE_PRODUCT	"rutherford"
