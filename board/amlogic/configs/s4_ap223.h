	...
	"boot_flag=0\0"\
        ...
        "init_display="\
            ...
            "else "\
                ...
                "run storeargs;"\
                "hdmitx hpd;hdmitx get_preferred_mode;hdmitx get_parse_edid;dovi process;watermark_init;osd open;osd clear;run load_bmp_logo;bmp scale;vout output ${outputmode};dovi set;dovi pkg;vpp hdrpkt;"\
            "fi;fi;"\
            "\0"\
		"storage_param="\
        ...
        "cmdline_keys="\
            ...
            "if keyman init 0x1234; then "\
				...
				"else "\
					"setenv bootargs ${bootargs} androidboot.serialno=ap223${cpu_id};"\
					"setenv serial ap223${cpu_id}; setenv serial# ap223${cpu_id};"\
				"fi;"\
