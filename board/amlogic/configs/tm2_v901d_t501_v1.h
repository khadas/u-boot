...
/*
 * board/amlogic/configs/tm2_v901d_t501_v1.h
 *
        ...
        "cmdline_keys="\
            "if keyman init 0x1234; then "\
                "if keyman read usid ${loadaddr} str; then "\
                    ...
                    "setenv serial ${usid};"\
                "else "\
					"setenv bootargs ${bootargs} androidboot.serialno=t501_${cpu_id};"\
					"setenv serial t501_${cpu_id};"\
                "fi;"\
...
#define CONFIG_DEVICE_PRODUCT	"v901d_t501"
