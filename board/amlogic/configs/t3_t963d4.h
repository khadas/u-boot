...
#define AML_VCCK_INIT_VOLTAGE	  999	    //VCCK power up voltage
	...
	"check_display="\
        ...
        "cmdline_keys="\
            ...
            "if keyman init 0x1234; then "\
				...
				"else "\
					"setenv bootargs ${bootargs} androidboot.serialno=t963d4${cpu_id};"\
					"setenv serial t963d4${cpu_id}; setenv serial# t963d4${cpu_id};"\
				"fi;"\
