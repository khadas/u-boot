...
#define PREI_USB_PHY_2_REG_BASE 0xfe004420
#define PREI_USB_PHY_3_REG_BASE 0xfe004480
#define PLL_REG32_16    (0xFe004000 + 0x40)
#define PLL_REG32_17    (0xFe004000 + 0x44)
#define PLL_REG32_18    (0xFe004000 + 0x48)
#define USB_PHY2_ENABLE			0x10000000
#define USB_PHY2_RESET			0x20000000
#define USB_REG_B 0xFe004000
#define USB_RESET1       (volatile unsigned long *)0xfe000004
...
void f_set_usb_phy_config(void)
{
	...
	*(volatile uint32_t *)P_AO_RTI_GEN_PWR_SLEEP0 = val & (~(0x1<<24));
	val = *(volatile uint32_t *)P_AO_RTI_GEN_PWR_ISO0;
	*(volatile uint32_t *)P_AO_RTI_GEN_PWR_ISO0 = val & (~(0x1<<24));
