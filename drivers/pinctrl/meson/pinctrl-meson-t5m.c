...
static struct meson_drive_bank meson_t5m_periphs_drive_banks[] = {
...
static struct meson_drive_data meson_t5m_periphs_drive_data = {
	.drive_banks	= meson_t5m_periphs_drive_banks,
	.num_drive_banks = ARRAY_SIZE(meson_t5m_periphs_drive_banks),
};

static struct meson_pinctrl_data meson_t5m_periphs_pinctrl_data = {
	.name		= "periphs-banks",
	...
	.drv_data	= &meson_t5m_periphs_drive_data,
};

static const struct udevice_id meson_t5m_pinctrl_match[] = {
	{
		.compatible = "amlogic,meson-t5m-periphs-pinctrl",
		.data = (ulong)&meson_t5m_periphs_pinctrl_data,
	},
	{ }
};

U_BOOT_DRIVER(meson_t5m_pinctrl) = {
	.name	= "meson-t5m-pinctrl",
	.id	= UCLASS_PINCTRL,
	.of_match = of_match_ptr(meson_t5m_pinctrl_match),
