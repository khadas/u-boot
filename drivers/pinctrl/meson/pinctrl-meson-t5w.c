...
static struct meson_pmx_group meson_t5w_analog_groups[] = {
...
static struct meson_pmx_func meson_t5w_analog_functions[] = {
...
static struct meson_pmx_group meson_t5w_aobus_groups[] = {
	GPIO_GROUP(GPIOD_0),
	GPIO_GROUP(GPIOD_1),
	GPIO_GROUP(GPIOD_2),
	GPIO_GROUP(GPIOD_3),
...
static struct meson_pmx_func meson_t5w_periphs_functions[] = {
...
static struct meson_bank meson_t5w_periphs_banks[] = {
	...
	BANK("GPIOZ_",    GPIOZ_0,    GPIOZ_19,
	     1,  0,  1,  0,   3,  0,  4,  0,  5,  0),
	BANK("GPIOH_",    GPIOH_0,    GPIOH_25,
	     2,  0,  2,  0,   6,  0,  7,  0,  8,  0),
	BANK("GPIOW_",    GPIOW_0,    GPIOW_12,
	     3,  0,  3,  0,   9,  0,  10,  0,  11, 0),
	BANK("GPIOM_",    GPIOM_0,    GPIOM_29,
	     4,  0,  4,  0,  12, 0,   13,  0,  14, 0),
	BANK("GPIOC_",    GPIOC_0,    GPIOC_14,
	     5,  0,  5,  0,  16, 0,   17,  0,  18, 0)
};

static struct meson_bank meson_t5w_aobus_banks[] = {
	/* name  first  last  pullen  pull  dir  out  in */
	BANK("GPIOD_",   GPIOD_0,  GPIOD_10,
	     3,  0,  2, 0,  0,  0,  4, 0,  1,  0),
...
static struct meson_drive_bank meson_t5w_periphs_drive_banks[] = {
	/* name	 first	last  reg  offset  */
	BANK_DRIVE("B",    GPIOB_0,    GPIOB_13, 0x20, 0),
	BANK_DRIVE("Z",    GPIOZ_0,    GPIOZ_19, 0x21, 0),
	BANK_DRIVE("H",    GPIOH_0,    GPIOH_25, 0x23, 0),
	BANK_DRIVE("W",    GPIOW_0,    GPIOW_12, 0x25, 0),
	BANK_DRIVE("M",    GPIOM_0,    GPIOM_29, 0x26, 0),
	BANK_DRIVE("C",    GPIOC_0,    GPIOC_14, 0x28, 0)
};

static struct meson_drive_data meson_t5w_periphs_drive_data = {
	.drive_banks     = meson_t5w_periphs_drive_banks,
	.num_drive_banks = ARRAY_SIZE(meson_t5w_periphs_drive_banks),
};

static struct meson_drive_bank meson_t5w_aobus_drive_banks[] = {
	/* name	 first	last  reg  offset  */
	BANK_DRIVE("D",   GPIOD_0,  GPIOD_10, 0x00, 0),
	BANK_DRIVE("E",   GPIOE_0,  GPIOE_1,  0x01, 0)
};

static struct meson_drive_data meson_t5w_aobus_drive_data = {
	.drive_banks     = meson_t5w_aobus_drive_banks,
	.num_drive_banks = ARRAY_SIZE(meson_t5w_aobus_drive_banks),
};

static struct meson_pinctrl_data meson_t5w_periphs_pinctrl_data = {
	.name		= "periphs-banks",
	...
	.drv_data	= &meson_t5w_periphs_drive_data,
};

static struct meson_pinctrl_data meson_t5w_aobus_pinctrl_data = {
	.name		= "aobus-banks",
	...
	.drv_data	= &meson_t5w_aobus_drive_data,
};

static struct meson_pinctrl_data meson_t5w_analog_pinctrl_data = {
	.name		= "analog-banks",
...
static const struct udevice_id meson_t5w_pinctrl_match[] = {
	{
		...
		.data = (ulong)&meson_t5w_periphs_pinctrl_data,
	},
	{
		.compatible = "amlogic,meson-t5w-aobus-pinctrl",
		.data = (ulong)&meson_t5w_aobus_pinctrl_data,
	},
	{
...
U_BOOT_DRIVER(meson_t5w_pinctrl) = {
	.name	= "meson-t5w-pinctrl",
	.id	= UCLASS_PINCTRL,
	.of_match = of_match_ptr(meson_t5w_pinctrl_match),
