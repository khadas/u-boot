...
static struct meson_drive_bank meson_t3_periphs_drive_banks[] = {
	/*  name	    first         lask        reg  offset*/
	BANK_DRIVE("D",     GPIOD_0,     GPIOD_10,    0x7,   0),
	...
	BANK_DRIVE("H1",    GPIOH_16,    GPIOH_27,    0xc1,  0),
	BANK_DRIVE("B",     GPIOB_0,     GPIOB_13,    0x2f,  0),
	BANK_DRIVE("C",     GPIOC_0,     GPIOC_15,    0x37,  0),
	BANK_DRIVE("W",     GPIOW_0,     GPIOW_12,    0x67,  0),
	BANK_DRIVE("M",     GPIOM_0,     GPIOM_15,    0x77,  0),
	BANK_DRIVE("M1",    GPIOM_16,    GPIOM_30,    0xc2,  0),
...
static struct meson_drive_data meson_t3_periphs_drive_data = {
	.drive_banks	= meson_t3_periphs_drive_banks,
	.num_drive_banks = ARRAY_SIZE(meson_t3_periphs_drive_banks),
};
...
static struct meson_pinctrl_data meson_t3_periphs_pinctrl_data = {
	...
	.drv_data	= &meson_t3_periphs_drive_data,
};

static const struct udevice_id meson_t3_pinctrl_match[] = {
	{
		.compatible = "amlogic,meson-t3-periphs-pinctrl",
		.data = (ulong)&meson_t3_periphs_pinctrl_data,
	},
	{ },
};

U_BOOT_DRIVER(meson_t3_pinctrl) = {
	.name	= "meson-t3-pinctrl",
	.id	= UCLASS_PINCTRL,
	.of_match = of_match_ptr(meson_t3_pinctrl_match),
