...
static struct meson_drive_bank meson_s5_storage_drive_banks[] = {
...
static struct meson_drive_bank meson_s5_periphs_drive_banks[] = {
	/*name	            first	 lask        reg offset*/
	BANK_DRIVE("TEST_N", GPIO_TEST_N, GPIO_TEST_N, 0x07,   0),
	BANK_DRIVE("A",      GPIOA_0,     GPIOA_10,    0x17,   0),
	BANK_DRIVE("C",      GPIOC_0,     GPIOC_7,     0x27,   0),
	BANK_DRIVE("D",      GPIOD_0,     GPIOD_11,    0x37,   0),
	BANK_DRIVE("E",      GPIOE_0,     GPIOE_4,     0x47,   0),
	BANK_DRIVE("H",      GPIOH_0,     GPIOH_8,     0x57,   0),
	BANK_DRIVE("T",      GPIOT_0,     GPIOT_24,    0x77,   0),
	BANK_DRIVE("X",      GPIOX_0,     GPIOX_19,    0x87,   0),
	BANK_DRIVE("Z",      GPIOZ_0,     GPIOZ_15,    0x97,   0),
};
...
static struct meson_drive_data meson_s5_periphs_drive_data = {
	.drive_banks	= meson_s5_periphs_drive_banks,
	.num_drive_banks = ARRAY_SIZE(meson_s5_periphs_drive_banks),
};

static struct meson_drive_data meson_s5_storage_drive_data = {
	.drive_banks	= meson_s5_storage_drive_banks,
	.num_drive_banks = ARRAY_SIZE(meson_s5_storage_drive_banks),
};
...
static struct meson_pinctrl_data meson_s5_storage_pinctrl_data = {
	...
	.drv_data	= &meson_s5_storage_drive_data,
};
...
static struct meson_pinctrl_data meson_s5_periphs_pinctrl_data = {
	...
	.drv_data	= &meson_s5_periphs_drive_data,
};

static const struct udevice_id meson_s5_pinctrl_match[] = {
	{
		.compatible = "amlogic,meson-s5-periphs-pinctrl",
		.data = (ulong)&meson_s5_periphs_pinctrl_data,
	},
	{
		.compatible = "amlogic,meson-s5-storage-pinctrl",
		.data = (ulong)&meson_s5_storage_pinctrl_data,
	},
	{ }
};

U_BOOT_DRIVER(meson_s5_pinctrl) = {
	.name	= "meson-s5-pinctrl",
	.id	= UCLASS_PINCTRL,
	.of_match = of_match_ptr(meson_s5_pinctrl_match),
