...
static struct meson_pmx_group meson_a5_periphs_groups[] = {
	GPIO_GROUP(GPIOE_0),
	GPIO_GROUP(GPIOE_1),
...
static struct meson_pmx_func meson_a5_periphs_functions[] = {
...
static struct meson_bank meson_a5_periphs_banks[] = {
	...
	BANK("GPIOH_", GPIOH_0,    GPIOH_4,
		0x73,  0,  0x74,  0,  0x72, 0,  0x71, 0,  0x70, 0),
	BANK("GPIOD_", GPIOD_0,    GPIOD_15,
		0x33,  0,  0x34,  0,  0x32, 0,  0x31, 0,  0x30, 0),
	BANK("GPIOT_", GPIOT_0,    GPIOT_13,
...
static struct meson_drive_bank meson_a5_periphs_drive_banks[] = {
	/*name	            first	 lask        reg offset*/
	BANK_DRIVE("B",      GPIOB_0,     GPIOB_13,    0x67, 0),
	BANK_DRIVE("C",      GPIOC_0,     GPIOC_10,    0x57,  0),
	BANK_DRIVE("E",      GPIOE_0,     GPIOE_1,     0x47, 0),
	BANK_DRIVE("H",      GPIOH_0,     GPIOH_4,     0x77, 0),
	BANK_DRIVE("D",      GPIOD_0,     GPIOD_15,    0x37, 0),
	BANK_DRIVE("T",      GPIOT_0,     GPIOT_13,    0x27,  0),
	BANK_DRIVE("X",      GPIOX_0,     GPIOX_19,    0x17,  0),
	BANK_DRIVE("Z",      GPIOZ_0,     GPIOZ_15,    0x07,  0),
...
static struct meson_drive_data meson_a5_periphs_drive_data = {
	.drive_banks	= meson_a5_periphs_drive_banks,
	.num_drive_banks = ARRAY_SIZE(meson_a5_periphs_drive_banks),
};

static struct meson_pinctrl_data meson_a5_periphs_pinctrl_data = {
	.name		= "periphs-banks",
	...
	.drv_data	= &meson_a5_periphs_drive_data,
};

static const struct udevice_id meson_a5_pinctrl_match[] = {
	{
		.compatible = "amlogic,meson-a5-periphs-pinctrl",
		.data = (ulong)&meson_a5_periphs_pinctrl_data,
	},
	{ }
};

U_BOOT_DRIVER(meson_a5_pinctrl) = {
	.name	= "meson-a5-pinctrl",
	.id	= UCLASS_PINCTRL,
	.of_match = of_match_ptr(meson_a5_pinctrl_match),
