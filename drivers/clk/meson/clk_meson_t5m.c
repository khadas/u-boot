...
static struct meson_gate gates[] = {
	{CLKID_SPICC_A_GATE, T5M_CLKCTRL_SPICC_CLK_CTRL, 6},
	{CLKID_SPICC_B_GATE, T5M_CLKCTRL_SPICC_CLK_CTRL, 22},
	{CLKID_SPICC_C_GATE, T5M_CLKCTRL_SPICC_CLK_CTRL1, 6},
	{CLKID_SAR_ADC_GATE, T5M_CLKCTRL_SAR_CLK_CTRL0, 8},
	{CLKID_SD_EMMC_B_GATE, T5M_CLKCTRL_SD_EMMC_CLK_CTRL, 23},
	{CLKID_SD_EMMC_C_GATE, T5M_CLKCTRL_NAND_CLK_CTRL, 7},
};
...
static struct meson_mux muxes[] = {
	{CLKID_SPICC_A_MUX, T5M_CLKCTRL_SPICC_CLK_CTRL, 7,  0x7, spicc_parents, ARRAY_SIZE(spicc_parents)},
	{CLKID_SPICC_B_MUX, T5M_CLKCTRL_SPICC_CLK_CTRL, 23,  0x7, spicc_parents, ARRAY_SIZE(spicc_parents)},
	{CLKID_SPICC_C_MUX, T5M_CLKCTRL_SPICC_CLK_CTRL1, 7,  0x7, spicc_parents, ARRAY_SIZE(spicc_parents)},
	{CLKID_SARADC_MUX, T5M_CLKCTRL_SAR_CLK_CTRL0, 9, 0x3, saradc_parents, ARRAY_SIZE(saradc_parents)},
	{CLKID_SD_EMMC_B_MUX, T5M_CLKCTRL_SD_EMMC_CLK_CTRL, 25, 0x7, sd_emmc_parents, ARRAY_SIZE(sd_emmc_parents)},
	{CLKID_SD_EMMC_C_MUX, T5M_CLKCTRL_NAND_CLK_CTRL, 9, 0x7, sd_emmc_parents, ARRAY_SIZE(sd_emmc_parents)},
};

static struct meson_div divs[] = {
	{CLKID_SPICC_A_DIV, T5M_CLKCTRL_SPICC_CLK_CTRL, 0, 6, CLKID_SPICC_A_MUX},
	{CLKID_SPICC_B_DIV, T5M_CLKCTRL_SPICC_CLK_CTRL, 16, 6, CLKID_SPICC_B_MUX},
	{CLKID_SPICC_C_DIV, T5M_CLKCTRL_SPICC_CLK_CTRL1, 0, 6, CLKID_SPICC_C_MUX},
	{CLKID_SARADC_DIV, T5M_CLKCTRL_SAR_CLK_CTRL0, 0, 8, CLKID_SARADC_MUX},
	{CLKID_SD_EMMC_B_DIV, T5M_CLKCTRL_SD_EMMC_CLK_CTRL, 16, 7, CLKID_SD_EMMC_B_MUX},
	{CLKID_SD_EMMC_C_DIV, T5M_CLKCTRL_NAND_CLK_CTRL, 0, 7, CLKID_SD_EMMC_C_MUX},
};

static struct parm meson_fixed_pll_parm[3] = {
	{T5M_ANACTRL_FIXPLL_CTRL0, 0, 8}, /* pm */
	{T5M_ANACTRL_FIXPLL_CTRL0, 16, 5}, /* pn */
	{T5M_ANACTRL_FIXPLL_CTRL0, 12, 3}, /* pod */
};

static struct parm meson_sys_pll_parm[3] = {
	{T5M_ANACTRL_SYS0PLL_CTRL0, 0, 8}, /* pm */
	{T5M_ANACTRL_SYS0PLL_CTRL0, 16, 5}, /* pn */
	{T5M_ANACTRL_SYS0PLL_CTRL0, 12, 3}, /* pod */
};

static struct parm meson_gp0_pll_parm[3] = {
	{T5M_ANACTRL_GP0PLL_CTRL0, 0, 9}, /* pm */
	{T5M_ANACTRL_GP0PLL_CTRL0, 16, 5}, /* pn */
	{T5M_ANACTRL_GP0PLL_CTRL0, 10, 3}, /* pod */
};
