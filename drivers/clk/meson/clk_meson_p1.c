...
static struct meson_gate gates[] = {
	{CLKID_SPICC_A_GATE, P1_CLKCTRL_SPICC_CLK_CTRL, 6},
	{CLKID_SPICC_B_GATE, P1_CLKCTRL_SPICC_CLK_CTRL, 22},
	{CLKID_SPICC_C_GATE, P1_CLKCTRL_SPICC_CLK_CTRL1, 6},
	{CLKID_SPICC_D_GATE, P1_CLKCTRL_SPICC_CLK_CTRL1, 22},
	{CLKID_SPICC_E_GATE, P1_CLKCTRL_SPICC_CLK_CTRL2, 6},
	{CLKID_SPICC_F_GATE, P1_CLKCTRL_SPICC_CLK_CTRL2, 22},
	{CLKID_SAR_ADC_GATE, P1_CLKCTRL_SAR_CLK_CTRL0, 8},
	{CLKID_SD_EMMC_A_GATE, P1_CLKCTRL_SD_EMMC_CLK_CTRL, 7},
	{CLKID_SD_EMMC_C_GATE, P1_CLKCTRL_NAND_CLK_CTRL, 7},
};
...
static struct meson_mux muxes[] = {
	{CLKID_SPICC_A_MUX, P1_CLKCTRL_SPICC_CLK_CTRL, 7,  0x7, spicc_parents, ARRAY_SIZE(spicc_parents)},
	{CLKID_SPICC_B_MUX, P1_CLKCTRL_SPICC_CLK_CTRL, 23,  0x7, spicc_parents, ARRAY_SIZE(spicc_parents)},
	{CLKID_SPICC_C_MUX, P1_CLKCTRL_SPICC_CLK_CTRL1, 7,  0x7, spicc_parents, ARRAY_SIZE(spicc_parents)},
	{CLKID_SPICC_D_MUX, P1_CLKCTRL_SPICC_CLK_CTRL1, 23,  0x7, spicc_parents, ARRAY_SIZE(spicc_parents)},
	{CLKID_SPICC_E_MUX, P1_CLKCTRL_SPICC_CLK_CTRL2, 7,  0x7, spicc_parents, ARRAY_SIZE(spicc_parents)},
	{CLKID_SPICC_F_MUX, P1_CLKCTRL_SPICC_CLK_CTRL2, 23,  0x7, spicc_parents, ARRAY_SIZE(spicc_parents)},
	{CLKID_SARADC_MUX, P1_CLKCTRL_SAR_CLK_CTRL0, 9, 0x3, saradc_parents, ARRAY_SIZE(saradc_parents)},
	{CLKID_SD_EMMC_A_MUX, P1_CLKCTRL_SD_EMMC_CLK_CTRL, 9, 0x7, sd_emmc_parents, ARRAY_SIZE(sd_emmc_parents)},
	{CLKID_SD_EMMC_C_MUX, P1_CLKCTRL_NAND_CLK_CTRL, 9, 0x7, sd_emmc_parents, ARRAY_SIZE(sd_emmc_parents)},
};

static struct meson_div divs[] = {
	{CLKID_SPICC_A_DIV, P1_CLKCTRL_SPICC_CLK_CTRL, 0, 6, CLKID_SPICC_A_MUX},
	{CLKID_SPICC_B_DIV, P1_CLKCTRL_SPICC_CLK_CTRL, 16, 6, CLKID_SPICC_B_MUX},
	{CLKID_SPICC_C_DIV, P1_CLKCTRL_SPICC_CLK_CTRL1, 0, 6, CLKID_SPICC_C_MUX},
	{CLKID_SPICC_D_DIV, P1_CLKCTRL_SPICC_CLK_CTRL1, 16, 6, CLKID_SPICC_D_MUX},
	{CLKID_SPICC_E_DIV, P1_CLKCTRL_SPICC_CLK_CTRL2, 0, 6, CLKID_SPICC_E_MUX},
	{CLKID_SPICC_F_DIV, P1_CLKCTRL_SPICC_CLK_CTRL2, 16, 6, CLKID_SPICC_F_MUX},
	{CLKID_SARADC_DIV, P1_CLKCTRL_SAR_CLK_CTRL0, 0, 8, CLKID_SARADC_MUX},
	{CLKID_SD_EMMC_A_DIV, P1_CLKCTRL_SD_EMMC_CLK_CTRL, 0, 7, CLKID_SD_EMMC_A_MUX},
	{CLKID_SD_EMMC_C_DIV, P1_CLKCTRL_NAND_CLK_CTRL, 0, 7, CLKID_SD_EMMC_C_MUX},
};
