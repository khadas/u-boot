				...
				int bypass, unsigned int mode, unsigned int ckdi)
{
	...
	lcd_ana_write(ANACTRL_DIF_PHY_CNTL8, chdig[0] | amp);
	...
	lcd_ana_write(ANACTRL_DIF_PHY_CNTL9, chdig[1] | amp);
	...
	lcd_ana_write(ANACTRL_DIF_PHY_CNTL10, chdig[2] | amp);
	...
	lcd_ana_write(ANACTRL_DIF_PHY_CNTL11, chdig[3] | amp);
	...
	lcd_ana_write(ANACTRL_DIF_PHY_CNTL12, chdig[4] | amp);
	...
	lcd_ana_write(ANACTRL_DIF_PHY_CNTL13, chdig[5] | amp);
