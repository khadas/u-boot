...
#define LCD_UKEY_FR_AUTO_DISABLE   (LCD_UKEY_MODEL_NAME + 81)
#define LCD_UKEY_FRAME_RATE_MIN    (LCD_UKEY_MODEL_NAME + 82)
#define LCD_UKEY_FRAME_RATE_MAX    (LCD_UKEY_MODEL_NAME + 83)
/* interface (20Byte) */
